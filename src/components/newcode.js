...
function About(props) {
    if(props.leadersLoading){
        ...
        console.log(props.leaders+props.leadersErrMess+props.leadersLoading)
        ...
        <div className="container">
            ...
            <div className="row row-content">
                ...
                <div className="col-12">
                    ...
                    <Media list>
                        {leaders}
                       {/* <leaders leader={props.leaders} isLoading={props.leadersLoading} errMess={props.leadersErrMess} /> */}
                    </Media>
                </div>
            </div>
        </div>
